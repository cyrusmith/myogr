...
describe LocationsController do
  ...
  describe "GET index" do
    it "assigns all addresses as @addresses" do
      address = Location.create! valid_attributes
      get :index, {}, valid_session
      assigns(:locations).should eq([address])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested address as @address" do
      ...
      assigns(:location).should eq(address)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested address" do
        ...
        put :update, {:id => address.to_param, :location => { "these" => "params" }}, valid_session
      end

      it "assigns the requested address as @address" do
        address = Location.create! valid_attributes
        put :update, {:id => address.to_param, :location => valid_attributes}, valid_session
        assigns(:location).should eq(address)
      end
    ...
    describe "with invalid params" do
      it "assigns the address as @address" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Location.any_instance.stub(:save).and_return(false)
        put :update, {:id => address.to_param, :location => {  }}, valid_session
        assigns(:location).should eq(address)
      end
